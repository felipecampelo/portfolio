...
1. **Camada de EL (extract-load)** declarativa com Meltano, centralizando pipelines em arquivos de projeto, com ambiente (dev/prod), e conectores Singer, incluindo implementações customizadas onde não havia TAP pronto para a fonte. A carga segue para o Snowflake de forma consistente.
